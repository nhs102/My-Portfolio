        ...
        <div className="text-center">
          ...
          >
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 text-left">
              I am a <strong className="text-blue-400 font-bold">Web Designer & Full-Stack Developer</strong> who builds <strong className="text-white font-bold bg-blue-900/30 px-2 py-0.5 rounded">reliable, data-driven platforms</strong> that solve real business problems. I specialize in AI-native platforms and PropTech innovation, bridging high-performance backends with polished frontends.
            </p>
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 text-left">
              With a strong foundation in <strong className="text-white font-bold bg-green-900/30 px-2 py-0.5 rounded">React & Node.js</strong>, I focus on maintainable architecture and practical solutions. By combining engineering with <strong className="text-white font-bold bg-pink-900/30 px-2 py-0.5 rounded">UI/UX design</strong> and <strong className="text-white font-bold bg-purple-900/30 px-2 py-0.5 rounded">practical AI integration</strong>, I create intuitive products that simplify complex workflows, improve user experience, and deliver measurable business results.
            </p>
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-6 text-left">
              Furthermore, I bring hands-on experience in <strong className="text-white font-bold bg-orange-900/30 px-2 py-0.5 rounded">digital marketing, social media management, and video production</strong>. By leveraging tools like Premiere Pro and After Effects, I produce engaging multimedia content, manage official Instagram pages, and execute targeted ad campaigns that drive traffic and deliver tangible business outcomes.
            </p>
            ...
            <div className="mt-12 pt-8 border-t border-white/10">
              ...
              <div className="flex flex-wrap gap-4 justify-start">
                <span className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 hover:bg-white/10 hover:text-white transition-colors cursor-default">
                  <Video className="w-4 h-4 text-orange-400" /> Video Production
                </span>
                <span className="flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm text-gray-300 hover:bg-white/10 hover:text-white transition-colors cursor-default">
